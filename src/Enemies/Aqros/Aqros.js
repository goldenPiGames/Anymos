var AqrosSpriteNames = ["Standing"]
const AQROS_BASE_SPEED = 4;
function Aqros() {
	
}
Aqros.prototype = Object.create(GameObjectBase);

function AqrosEvil(x, y, facingRight, bl, br, bt, bb) {
	this.name = name;
	this.hp = this.maxhp;
	this.x = x;
	this.y = y;
...
AqrosEvil.prototype = Object.create(Aqros.prototype);
AqrosEvil.prototype.speciesName = "Aqros";
AqrosEvil.prototype.team = "Sqarnos";
AqrosEvil.prototype.hittable = true;
AqrosEvil.prototype.damageable = true;
AqrosEvil.prototype.maxhp = 2400;
AqrosEvil.prototype.doesGravity = true;
AqrosEvil.prototype.update = function() {
...
AqrosEvil.prototype.draw = function() {
	var state;
	if (this.rainTrapping) {
		return;
	} else {
...
AqrosEvil.prototype.rainTrap = function() {
	this.rainTrapping = 1;
	this.hittable = false;
...
AqrosEvil.prototype.rainTrapReturn = function() {
	this.hittable = true;
...
AqrosEvil.prototype.flood = function() {
	this.flooding = true; 
	...
	gameObjects.push(new FadeDrawing(function(){ctx.fillStyle="#000000";ctx.fillRect(0,0,canvas.width,canvas.height);}, 1, .25));
	/*this.raingen = new RainGenerator(20, 5);
	this.raingen.boundTop = this.boundTop + 1;
	this.raingen.boundLeft = this.rainingSide ? this.mirror.x + this.mirror.width/2 : this.boundLeft;
	this.raingen.boundRight = !this.rainingSide ? this.mirror.x - this.mirror.width/2 : this.boundRight;
...
AqrosEvil.prototype.floodReturn = function() {
	this.flooding = false;
	this.platforms.forEach(function(plat) {
		plat.dead = true;
	});
