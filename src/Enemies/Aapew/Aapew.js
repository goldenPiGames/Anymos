...
function Aapew(facingRight, x, y, offScreen) {
	this.hp = this.maxhp;
...
Aapew.prototype = Object.create(GameObjectBase);
Aapew.prototype.speciesName = "Aapew";
Aapew.prototype.team = "Sqarnos";
Aapew.prototype.spriteNames = ["Flying"];
Aapew.prototype.hittable = true;
Aapew.prototype.damageable = true;
Aapew.prototype.maxhp = 120;
Aapew.prototype.update = function() {
	if (this.moving) {
