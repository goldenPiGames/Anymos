function DoubleJumpPickup(x, y, doDialog = false) {
	this.x = x;
	this.y = y;
	this.width = 20;
	this.height = 20;
...
function DoubleJumpPickup(x, y, doDialog = true) {
	this.x = x;
	this.y = y;
	this.width = 20;
	this.height = 20;
...
DoubleJumpPickup.prototype = Object.create(GameObjectBase)
DoubleJumpPickup.prototype.update = function () {
	if (this.isTouching(player) && controller.interactClicked && player.special != "Syklos' Double Jump") {
...
DoubleJumpPickup.prototype.draw = function () {
	if (player.special != "Syklos' Double Jump")
		drawSpriteOnStage(Syklos.prototype.sprites.Pickup, this.x, this.y);
}

function resolveDoubleJump() {
