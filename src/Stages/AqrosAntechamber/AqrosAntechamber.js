Stages.AqrosAntechamber = {
	...
	load : function(doStuff) {
		...
		if (doStuff) {
			zoom = 2;
			zoomd = 2;
			dialog.begin(new DialogLine("???", "So you've found your way into my abode.", "#0000FF"),
		...
		gameObjects = [new ReflectorPickup(340, 230, doStuff), new Mirror(280, 240, 220), new Vessel("AqrosAntechamberLowerRight", 520, 228), new Goalpost("AqrosAtrium", 10, 120, 95)];
	},
