Stages.SpadeCity = {
	...
	load : function() {
		...
		gameObjects = [new MovingPlatformSpawner(2010,970, 20, 7, 2010,990, 2010,600, 1990,600), new MovingPlatformSpawner(1890,970, 20, 7, 1890,990, 1890,600, 1910,600), new MovingPlatformSpawner(1290,970, 20, 7, 1290,990, 1290,580, 1310,580), new Vessel("SpadeCityEtra", 1880, 948), new Vessel("SpadeCityVivent", 1690, 730), new Vessel("SpadeCityAlley2", 1570, 958), new Vessel("SpadeCityConstructionTop", 840, 538), new Vessel("SpadeCityConstructionBottom", 870, 938), new Vessel("SpadeCitySkydz", 526, 600), new Goalpost("SPDAirport", 10, 960, 90),
		new NPC("SpadeCityViventCitizen", function(){return Teion.prototype.sprites.Normal}, 1658, 780, false,
		...
		new NPC("SpadeCityMuus", function(){return Teion.prototype.sprites.Normal}, 1342, 580, false,
			new DialogLine("Muus", "Ah! Are you here to join our cause?", "#BFBFBF"),
		),
		new NPC("SpadeCityDeija", function(){return Teion.prototype.sprites.Normal}, 1410, 580, false,
		...
		new ObscurerRect(2010, 980, 40, 379, "#7F7F7F"), new ObscurerRect(1890, 980, 40, 379, "#7F7F7F"), new ObscurerRect(1670, 780, 160, 80, "#7F7F7F"), new ObscurerRect(1350, 970, 160, 450, "#7F7F7F"), new ObscurerRect(490, 970, 160, 470, "#7F7F7F")];
