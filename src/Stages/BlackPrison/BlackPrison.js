Stages.BlackPrison = {
	...
	load : function(doStuff) {
		...
		gameObjects = [new Rumble(40, 560, 10, 70, true, ()=>player.drained=false, new Drrk("BlackPrisonDrrk", 300, 60, false, true)),
			new NPC("BlackPrisonNaluxos", Naluxos.prototype.sprites.standing, 580, 60, false,
