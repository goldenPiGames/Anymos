Stages.HeartFarms = {
	...
	load : function() {
		...
		let B = {nae:"Barn", solid:true,color:"#7F7F7F"};
		let _ = AIR;
		staticColl =
		...
		gameObjects = [new Vessel("HeartFarmsLeftOfBarn", 590, 214), new Rumble(180, 220, 300, 200, true, doNothing, new SnakeEyes(50, 220, 50, 310, true, true)), new Goalpost("SpadeCity", 10, 220, 120)];
		return {
	...
	selectX : Stages.DiamondHighway.selectX,
