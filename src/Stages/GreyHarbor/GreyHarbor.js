Stages.GreyHarbor = {
	...
	load : function() {
		...
		gameObjects = [new Rumble(700, 330, 420, 360, true, function(){gameObjects.push(new Goalpost("ZagadCrossing", 410, 200, 100))}, new Fricchee("GreyHarborFricchee", 820, 240, false)), new Vessel("GreyHarborOut", 740, 120), new NPC("GreyHarborCapes", function(){return Teion.prototype.sprites.Caps}, 140, 220, true,
	...
	selectX : Stages.WhitePlains.selectX,
	selectY : Stages.WhitePlains.selectY + LS_Y_SPACING,
	par : 480,
