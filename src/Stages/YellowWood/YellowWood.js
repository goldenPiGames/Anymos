	...
	load : function(doStuff) {
		...
		gameObjects = [
			...
			new MonologueSpot("YellowWoodTreetopViewMono", 960, 58,
				...
				"When I look to the left, I get a strange feeling of both dread and familiarity. And... anger? I'm not sure.",
				()=>player.facingRight = true,
				"To the right, I also can't see much. But I get a feeling of... wonderment.",
				"Which way to go? I should pick one way or the other. But I needn't worry too much."),
		];
	},
	vessels : ["YellowWoodTreetop", "YellowWoodHillCave", "YellowWoodUnderBranch", "YellowWoodUnderLedge", "YellowWoodBen", "YellowWoodNathan", "YellowWoodKaren"],
	//selectX : 0,
	//selectY : 150,
