const MUSIC_LIST = [
	...
	{name:"Blast",                          by:"PeriTune",    site:"https://peritune.com/blast/", 											prelude:"Fwegos"},
	...
	{name:"Dark Anthem",                    by:"Darren Curtis", yt:"G-VY51L2AQU", site:"https://www.darrencurtismusic.com/horror-mystery", 	prelude:"Palace"},
	{name:"Decisions",                      by:"Eric Matyas", site:"https://soundimage.org/introspective/", 							   	prelude:"Tutorial"},
	{name:"Demise",                         by:"PeriTune",      yt:"Ouj_cwWJdmo", site:"https://peritune.com/demise/", 						prelude:"Bolizos"},
	...
	{name:"Glory Eternal",                  by:"Darren Curtis", yt:"Qx1ypzkhTy0", site:"https://www.darrencurtismusic.com/horror-mystery", 	prelude:"Sqarnos"},
	...
	{name:"Maleficent Mysticism",           by:"Darren Curtis", yt:"20ZsqH6rb6Y", site:"https://www.darrencurtismusic.com/horror-mystery", 	prelude:"Peaceful Field"},
	...
	{name:"Move it Out",                    by:"Eric Matyas", site:"https://soundimage.org/epic-battle/", 									prelude:"Baron"},
	...
	{name:"Strategy 3",                     by:"PeriTune",      yt:"tqS-DwicQCo", site:"https://peritune.com/strategy3/", 					prelude:"Burning Forest"},
	{name:"Surreal Chase",                  by:"Eric Matyas", site:"https://soundimage.org/action/"},
	{name:"Tempest",                        by:"Darren Curtis", yt:"NsSYDbyQteg", site:"https://www.darrencurtismusic.com/fantasy", 		prelude:"Stormy Plateau"},
	...
	{name:"The Old Country Farm",           by:"Darren Curtis", yt:"HPt2ngfRQ8I", site:"https://www.darrencurtismusic.com/fantasy", 		prelude:"Peaceful Field Intro"},
...
var jukebox = {
	...
	draw : function() {
		...
		for (var i = 0; i < MUSIC_LIST.length; i++) {
			...
			ctx.fillText(MUSIC_LIST[i].by, canvas.width * 2/3 - ctx.measureText(MUSIC_LIST[i].by).width, stagey(JUKEBOX_ENTRY_HEIGHT * (i+.5) + 5));
		}
